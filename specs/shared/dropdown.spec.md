...
**Tags on staging** do not use multiselect on one control:
each tag is a chip, and the user picks one new tag name at a time
through a single-value creatable searchable dropdown.
